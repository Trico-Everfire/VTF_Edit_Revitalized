 ...
 */
const char *ImageFormatToString( vtfpp::ImageFormat format );
 ...
 */
vtfpp::ImageFormat ImageFormatFromString( const char *arg );
 ...
 */
vtfpp::ImageFormat ImageFromatFromUserString( const char *userStr );
